...
class PDFViewerFromUrlNew extends StatelessWidget {
  PDFViewerFromUrlNew({Key key, @required this.url}) : super(key: key);
...
class PDFViewerFromUrlNewAsset extends StatelessWidget {
  PDFViewerFromUrlNewAsset({Key key, @required this.pdfAssetPath}) : super(key: key);
