...
/*  String mid = "LIVE_MID_HERE";
  ...
  //Testing
  String mid = "txSGuH70208097700957";
  String PAYTM_MERCHANT_KEY = "5_NRTmOfzPMv1Dkt";
...
//                    : Container(),
  ...
  void generateTxnToken(int mode) async {
    ...
    String orderId ="2158";// DateTime.now().millisecondsSinceEpoch.toString();
    ...
    try {
     /* final response = await http.post(
      ...
      String txnToken = "n2JbOOLlRkyQi\/eZ\/kJEOv+NWG6UsYLXhmSpkE\/thQ6UWC8VCRGRjGE4rhDppPpknKsCZ5Kuw7BxJNz2\/fNTSQNJIi5o1VmA5YLNDNfq4Cs=";
      setState(() {
